...
public class WeiboConnectionFactory extends OAuth2ConnectionFactory<Weibo> {
	...
	public WeiboConnectionFactory(String providerId, String consumerKey, String consumerSecret) {
		super(providerId, new WeiboServiceProvider(consumerKey, consumerSecret),
				new WeiboAdapter());
	}
